...
from menus.menu_trading import (
    menu_1_analyze_now,
    menu_7_launch_trainer,
    menu_99_start_trading,
)
from menus.menu_settings import (
    menu_2_change_symbol,
    menu_3_change_timeframe,
    menu_4_change_candles,
    menu_5_switch_account,
    menu_6_change_trade_mode,
    menu_8_toggle_auto_trade,
    menu_9_set_auto_lot,
    menu_10_set_auto_slippage,
    menu_11_toggle_auto_close_profit,
    menu_12_set_auto_close_target,
    menu_13_toggle_auto_analyze,
    menu_14_set_auto_analyze_interval,
    menu_15_toggle_bep,
    menu_16_set_bep_min_profit,
    menu_17_set_bep_spread_multiplier,
    menu_18_toggle_stpp_trailing,
    menu_19_set_step_lock_init,
    menu_20_set_step_step,
    menu_23_set_entry_decimals,
    menu_29_toggle_trade_always_on,
    menu_30_change_mode_settings,
...
from menus.menu_backtest import (
    menu_24_backtest_custom,
    menu_25_backtest_7d,
    menu_26_backtest_14d,
    menu_27_backtest_30d,
    menu_28_backtest_60d,
)
